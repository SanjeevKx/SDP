    ...
    <div className="w-full min-h-screen relative">
      ...
      <div className="p-8">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-gray-400 mb-6">Explore a variety of properties available for sale and rent in these vibrant cities. We have options to suit every need and budget.</p>
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 mb-6">Visit our handpicked selection of featured properties available for sale and rent.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border p-4 rounded-lg shadow-lg">
              ...
              <p className="text-gray-400">1800-1818 79th St</p>
              <p className="text-gray-400">4 Beds • 1 Baths • 400 sqft</p>
            ...
            <div className="border p-4 rounded-lg shadow-lg">
              ...
              <p className="text-gray-400">1020 Bloomingdale Ave</p>
              <p className="text-gray-400">4 Beds • 2 Baths • 450 sqft</p>
            ...
            <div className="border p-4 rounded-lg shadow-lg">
              ...
              <p className="text-gray-400">4330 Bell Shoals Rd</p>
              <p className="text-gray-400">4 Beds • 2 Baths • 400 sqft</p>
            ...
            <div className="border p-4 rounded-lg shadow-lg">
              ...
              <p className="text-gray-400">7728 60th St N</p>
              <p className="text-gray-400">3 Beds • 2 Baths • 300 sqft</p>
            ...
            <div className="border p-4 rounded-lg shadow-lg">
              ...
              <p className="text-gray-400">4514 Elm St</p>
              <p className="text-gray-400">2 Beds • 2 Baths • 150 sqft</p>
            ...
            <div className="border p-4 rounded-lg shadow-lg">
              ...
              <p className="text-gray-400">5512 62nd Ave</p>
              <p className="text-gray-400">1 Bed • 1 Bath • 120 sqft</p>
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 mb-4">Explore the range of services we offer to make your property experience seamless and enjoyable.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border p-4 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-400">Browse through our extensive listings to find your perfect home.</p>
            </div>
            <div className="border p-4 rounded-lg shadow-lg text-center">
              <User className="w-12 h-12 mx-auto mb-4" />
              <h3 className="text-xl font-bold">Sell a Home</h3>
              <p className="text-gray-400">Get expert advice and assistance to sell your home at the best price.</p>
            </div>
            <div className="border p-4 rounded-lg shadow-lg text-center">
              <Key className="w-12 h-12 mx-auto mb-4" />
              <h3 className="text-xl font-bold">Rent a Home</h3>
              <p className="text-gray-400">Find rental properties that meet your needs and budget.</p>
            </div>
          </div>
        </div>
      </div>
