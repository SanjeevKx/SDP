    ...
    <div className="p-4 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white p-4 rounded-lg shadow-lg flex items-center">
          ...
          <div>
            <h2 className="text-md font-semibold text-gray-700">Total Properties</h2>
        ...
        <div className="bg-white p-4 rounded-lg shadow-lg flex items-center">
          ...
          <div>
            <h2 className="text-md font-semibold text-gray-700">Today's Users</h2>
        ...
        <div className="bg-white p-4 rounded-lg shadow-lg flex items-center">
          ...
          <div>
            <h2 className="text-md font-semibold text-gray-700">Revenue</h2>
        ...
        <div className="bg-white p-4 rounded-lg shadow-lg flex items-center">
          ...
          <div>
            <h2 className="text-md font-semibold text-gray-700">New Orders</h2>
          ...
          <div className="bg-white p-3 rounded-lg shadow-md h-64">
            ...
            <ResponsiveContainer width="100%" height="80%">
              <LineChart data={dataLine}>
                ...
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="count" stroke="#8884d8" dot={{ fill: 'yellow', r: 6 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-lg">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center text-sm p-2 hover:bg-gray-50 rounded">
              ...
              <span className="text-xs text-gray-700">15m ago</span>
            </li>
            <li className="flex items-center text-sm p-2 hover:bg-gray-50 rounded">
              ...
              <span className="text-xs text-gray-700">3h ago</span>
            </li>
          </ul>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-lg">
            ...
            <li className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 flex items-center">
                  <Clock className="w-3 h-3 mr-1 text-gray-700" /> Tomorrow, 10:00 AM
                </p>
              </div>
            </li>
            <li className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 flex items-center">
                  <Clock className="w-3 h-3 mr-1 text-gray-700" /> Jul 30, 2:00 PM
                </p>
              </div>
            </li>
          </ul>
